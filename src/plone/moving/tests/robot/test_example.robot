...
#
#  $ bin/test -s plone.moving -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src plone.moving.testing.PLONE_MOVING_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plone/moving/tests/robot/test_example.robot
#
